          ...
          <div className="signledataset-main-div">
            ...
            >
              <div style={{ width: "50%" }}>
                ...
                >
                  ...
                  insightful and engaging visual representations of your data
                  and model outputs. Whether you need to plot graphs, generate
                  heatmaps, or visualize complex relationships, it has you
                  covered. By utilizing it, you can seamlessly leverage the
                  capabilities of (Numpy, Scipy, Scikit-learn, Theano,
                  TensorFlow, Keras, PyTorch, Pandas, Matplotlib) these
                  libraries to enhance your understanding of your machine
                  learning models. Simply ensure that your model includes the
                  above-mentioned libraries, and it will handle the rest. It
                  eliminates the need for high-end laptop or computer
                  configurations, enabling you to work with large datasets and
                  complex visualization computations effortlessly.
                </p>
              </div>
            ...
            <div style={{ padding: "20px 50px", display: "flex" }}>
              ...
              <div style={{ marginLeft: "15px" }}>
                ...
                <p>
                  After getting the JobID wait for some time and then click on
                  the Get CID.*{" "}
                </p>
                {/* {isVisible && (
                  <div className="popup">
