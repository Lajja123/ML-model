      ...
      {singleDataset ? (
        ...
        <div className="dataset-main-div">
          ...
          <div className="main-dataset-grid">
            ...
            >
              <img src={data3} alt="" className="dataset-img" />
              <div className="alldataset-grid">
                ...
                <div>
                  <p className="dataset-dec">
                    Discover the true earning potential of data scientists
                    across a vast array of companies with our comprehensive
                    dataset. Featuring average salaries from over 8000
                    companies, this dataset provides a valuable resource for job
                    seekers, industry professionals, and data enthusiasts alike.
                    Uncover salary trends, compare compensation across sectors,
                    and gain insights into the factors influencing data
                    scientist salaries. Join the exploration, share your
                    findings, and contribute to the collective knowledge of the
                    Kaggle community. Let's dive into the world of data
                    scientist salaries together! Access the dataset now and
                    unlock a wealth of information for your analyses.
                  </p>
                </div>
                <button
                  className="dataset-viewmore"
